import com.bignerdranch.neythack.Direction
import com.bignerdranch.neythack.Monster
import com.bignerdranch.neythack.Room
import com.bignerdranch.neythack.TownSquare
...
object Game{
    ...
    fun play(){
        while (true){
            ...
            print("> 명령을 입력하세요: ")
            println(readLine()?.let { GameInput(it).processCommand() })
        }
    }
